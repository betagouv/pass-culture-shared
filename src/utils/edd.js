export const edd_codes_musique = [
    ...
    {code: 530, label: 'Reggae', children: [
    ...
    {code: 600, label: 'Classique', children: [
    ...
    {code: 700, label: 'Musique du Monde', children: [
    ...
    {code: 870, label: 'Country', children: [
    ...
    {code: 880, label: 'Electro', children: [
    ...
    {code: 900, label: 'Hip-Hop/Rap', children: [
    ...
    {code: 930, label: 'Gospel', children: [
    ...
    {code: 1000, label: 'Chansons / Variétés', children: [
...
export const edd_codes = [
  ...
  {code: 200, label: 'Cirque / Magie', children: [
  ...
  {code: 400, label: 'Humour / Café-théâtre', children: [
  ...
  {code: 1200, label: 'Spectacle Jeunesse', children: [
  ...
  {code: 1500, label: 'Autre (spectacle sur glace, historique, aquatique, …)  ', children: [
